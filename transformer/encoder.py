...
from wenet.transformer.encoder_layer import EfficientConformerEncoderLayer
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        conformer_type: str = "efficientconformer",
    ):
        """
        Args:
    ...
    def forward(
        ...
        if conformer_type == "efficientconformer":
            for layer in self.encoders:
                x, _, _ = layer(xs, chunk_masks, pos_emb)
                # Strided Block
                if layer.stride > 1:
...
class TransformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        super().__init__(input_size, output_size, attention_heads,
                         ...
                         global_cmvn, use_dynamic_left_chunk, conformer_type)
...
class EfficientConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        # Conformer Blocks
        self.blocks = torch.nn.ModuleList([EfficientConformerEncoderLayer(
